...
<div class="max-w-2xl p-6 rounded-lg">
  <h3 class="text-lg font-semibold text-gray-900 mb-6">Tambah Admin</h3>
      @if ($errors->any())
    ...
    <form action="{{ route('admin.admins.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="mb-4">
        <label for="nama_admin" class="block font-md text-sm text-gray-700 mb-2">Nama Admin</label>
      ...
      <div class="mb-4">
        <label for="email_admin" class="block font-md text-sm text-gray-700 mb-2">Email Admin</label>
      ...
      <div class="mb-4">
        <label for="password" class="block font-md text-sm text-gray-700 mb-2">Password Admin</label>
